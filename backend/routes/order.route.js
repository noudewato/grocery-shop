...
import {
  GetOrders,
  addOrderItems,
  calculateAllOrderAmount,
  calculateDiverseOrderAmount,
  getMyOrders,
  getOrderById,
  getPendingOrder,
  updateOrderStatus,
...
orderRouter.get("/status", getPendingOrder);
orderRouter.get("/diversAmount", calculateDiverseOrderAmount);
orderRouter.get("/totalAmount", calculateAllOrderAmount);
